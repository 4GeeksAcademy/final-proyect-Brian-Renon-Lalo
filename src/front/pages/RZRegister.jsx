                ...
                <div className="register-form-container">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <input className="form-control" type={showPassword ? "text" : "password"} id="password" value={password} placeholder="Ejemploo!" onChange={(e) => setPassword(e.target.value)} required/>
                            <span
